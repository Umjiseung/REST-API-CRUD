package com.search.test.doamin.board.controller;


import com.search.test.doamin.board.dto.request.BoardCreateRequest;
import com.search.test.doamin.board.dto.request.BoardUpdateRequest;
import com.search.test.doamin.board.dto.response.BoardCreateResponse;
import com.search.test.doamin.board.dto.response.BoardGetResponse;
import com.search.test.doamin.board.dto.response.BoardInfoResponse;
import com.search.test.doamin.board.dto.response.BoardUpdateResponse;
import com.search.test.doamin.board.service.BoardService;
